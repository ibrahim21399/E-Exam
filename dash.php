  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="dash.php?q=0">Quizs<span class="sr-only">(current)</span></a></li>
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Studentcode</b></td><td><b>Faculy</b></td><td><b>level</b></td><td><b>department</b></td><td><b>Score</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
$s=$row['score'];
$q12=mysqli_query($conn,"SELECT * FROM students WHERE email='$e' " )or die('Error231');
...
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$studentcode.'</td><td>'.$faculty.'</td><td>'.$level.'</td><td>'.$department.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
...
$result = mysqli_query($conn,"SELECT * FROM students") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Email</b></td><td><b>Studentcode</b></td><td><b>Mobile</b></td><td><b>Faculty</b></td><td><b>level</b></td><td><b>Department</b></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$gender = $row['gender'];
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" name="btnq" style="margin-left:45%" class="btn btn-primary" value="Submit" class="btn btn-primary"/>
  </div>
</div>
...
echo '<div class="form-group">
  <label class="col-md-12 control-label" for=""></label>
  <div class="col-md-12"> 
    <input name="btnq2" type="submit" style="margin-left:45%" class="btn btn-primary" value="Submit" class="btn btn-primary"/>
  </div>
</div>
